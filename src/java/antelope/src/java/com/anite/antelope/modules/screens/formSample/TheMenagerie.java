 ...
 * @author Ben Gidley
 */
public class TheMenagerie extends VelocityScreen {

    protected void doBuildTemplate(RunData data, Context context)
            throws Exception {

        Session session = PersistenceLocator.getInstance().getCurrentSession();
        Query ownedAnimals = session.getNamedQuery("ownedAnimals");
        
        ownedAnimals.setString("ownerName", data.getUser().getName());
        List animals = ownedAnimals.list();
