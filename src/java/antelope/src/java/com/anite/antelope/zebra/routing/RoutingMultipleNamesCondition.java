...
package com.anite.antelope.zebra.routing;
...
/**
 * Run routing if the instance routing answer contains the routing answer
 * can handle multiple successful routings uisnng ';' as a seperator.
 * @author Ben.Gidley
 */
public class RoutingMultipleNamesCondition implements IConditionAction{
     ...
     */
    public boolean runCondition(IRoutingDefinition routingDefinition, ITaskInstance taskInstance) throws RunRoutingException {
        return runCondition(routingDefinition, (AntelopeTaskInstance) taskInstance);
    }
    
    public boolean runCondition(IRoutingDefinition routingDefinition, AntelopeTaskInstance taskInstance) throws RunRoutingException {
