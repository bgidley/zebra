...
/**
 * Represents a lock on a process instance This is NOT foreigned keyed as it does not need to be and it needs to be
 * quick and simple
 * <p/>
 * This is keyed on ProcessID so we can ensure safety in a cluster
 * <p/>
