...
10. ~~**Security baseline is low** — no auth, no credential store, no encryption at rest~~ — F7 adds `CredentialStore` (OS keychain + file fallback) with CLI management. No auth layer or encryption at rest yet.
