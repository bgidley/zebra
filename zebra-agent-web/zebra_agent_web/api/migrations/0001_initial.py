    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["state", "created_at"], name="zebra_proce_state_2d453c_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.TextField(
                        blank=True, help_text="JSON serialized task result", null=True
                    ),
                ),
                (
                    "error",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["process_id", "state"], name="zebra_task__process_c202c0_idx"
                    )
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "output",
                    models.TextField(blank=True, help_text="Workflow output/result", null=True),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(fields=["-started_at"], name="zebra_workf_started_181076_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["run", "execution_order"], name="zebra_task__run_id_8217dd_idx"
                    )
                ],
            },
        ),
