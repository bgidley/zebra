    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["-created_at"], name="zebra_memor_created_750cc5_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["-timestamp"], name="zebra_memor_timesta_9a80c2_idx")
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "entry_count",
                    models.IntegerField(default=0, help_text="Number of entries summarized"),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(fields=["-created_at"], name="zebra_memor_created_7cfca9_idx")
                ],
            },
        ),
    ]
