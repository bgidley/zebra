...
public class PriorityManagerTest extends TestCase {
	...
	public void testPriorityManager() {
		PriorityManager priorityManager = (PriorityManager) RegistryManager.getInstance()
				.getRegistry().getService("zebra.priorityManager",
						PriorityManager.class);

		assertNotNull(priorityManager);
		
		Priority priority =priorityManager.getDefaultPriority();
		assertNotNull(priority);
		assertEquals(priority.getCaption(), PriorityManager.NORMAL);
