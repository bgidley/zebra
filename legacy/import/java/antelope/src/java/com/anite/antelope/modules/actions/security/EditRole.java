 ...
 *  
 */
public class EditRole extends SecureAction {
	...
	public void doPerform(RunData data, Context context) throws Exception {
		...
		if (form.isAllValid()) {
			...
			Field newRoleNameField = (Field) form.getFields().get("rolename");
			Field roleIdField = (Field) form.getFields().get("roleid");
			DynamicRole role = (DynamicRole) roleManager.getRoleById(Long
					.valueOf(roleIdField.getValue()));
			roleManager.renameRole(role, newRoleNameField.getValue());
		}
	}
}