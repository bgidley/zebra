...
- [ ] 9.3 Commit with message: `feat: add personal knowledge store (REQ-MEM-004)\n\nCloses #31`
- [ ] 9.4 Push to GitLab (`git push origin f31/personal-knowledge-store`) and verify CI pipeline passes (lint → unit → e2e)
- [ ] 9.5 Push branch to GitHub and open PR (`gh pr create --repo bgidley/zebra ...`)
